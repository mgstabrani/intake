...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="shortcut icon" href="img/dolphin.png">
        ...
        <div class="container mt-5 ">
            ...
            <div class="row justify-content-center">
                <div class="card" style="width: 18rem;">
                    <img src="img/dolphin.png" class="card-img-top" alt="dolphin" height="200" >
                    <div class="card-body">
                        <h3 class="card-text">Dolphin</h3>
                        <p>Do the best prepare for the worst</p>
                        <p>
                        <a href="/pdf/dolphin/dolphin-3.pdf" download class="btn btn-success">
                            Unduh soal
                        </a>
                        </p>
                        <p>
                        <a href="/sandi3-dolphin" class="btn btn-primary">
                            Next
                        </a>
                        <a href="/sandi2-dolphin" class="btn btn-danger">Back<a>
                        </p>
                    </div>
                </div>                      
            </div>
