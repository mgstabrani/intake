        ...
        <div class="container mt-5 ">
            ...
            <div class="row justify-content-center">
                <div class="card" style="width: 18rem;">
                    <img src="img/lion.png" class="card-img-top" alt="lion" height="220" >
                    <div class="card-body">
                        <h3 class="card-text">Lion</h3>
                        <p>Enjoy aja</p>
                        <p>
                        <a href="/pdf/lion//lion-3.pdf" download class="btn btn-success">
                            Unduh soal
                        </a>
                        </p>
                        <p>
                        <a href="/sandi3-lion" class="btn btn-primary">
                            Next
                        </a>
                        <a href="/sandi2-lion" class="btn btn-danger">Back<a>
                        </p>
                    </div>
                </div>                      
            </div>
