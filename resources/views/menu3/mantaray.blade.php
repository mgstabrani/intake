        ...
        <div class="container mt-5 ">
            ...
            <div class="row justify-content-center">
                <div class="card" style="width: 18rem;">
                    <img src="img/mantaray.png" class="card-img-top" alt="mantaray" height="220" >
                    <div class="card-body">
                        <h3 class="card-text">Mantaray</h3>
                        <p>Talk more do more/p>
                        <p>
                        <a href="/pdf/mantaray/mantaray-3.pdf" download class="btn btn-success">
                            Unduh soal
                        </a>
                        </p>
                        <p>
                        <a href="/sandi3-mantaray" class="btn btn-primary">
                            Next
                        </a>
                        <a href="/sandi2-mantaray" class="btn btn-danger">Back<a>
                        </p>
                    </div>
                </div>                      
            </div>
