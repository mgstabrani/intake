...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="shortcut icon" href="img/komodo.png">
        ...
        <div class="container mt-5 ">
            <div class="row justify-content-center">
                <div class="card" style="width: 18rem;">
                    <img src="img/komodo.png" class="card-img-top" alt="komodo" height="200" >
                    <div class="card-body">
                        <h3 class="card-text">Komodo</h3>
                        <p>Hip hip hura win</p>
                        <p>
                        <a href="/pdf/komodo/komodo-3.pdf" download class="btn btn-success">
                            Unduh soal
                        </a>
                        </p>
                        <p>
                        <a href="/sandi3-komodo" class="btn btn-primary">
                            Next
                        </a>
                        <a href="/sandi2-komodo" class="btn btn-danger">Back<a>
                        </p>
                    </div>
                </div>                      
            </div>
